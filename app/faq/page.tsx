...
const faqs = [
  {
    ...
    items: [
      ...
      {
        q: 'どんな学生が登録できますか？',
        a: '東京大学・京都大学・一橋大学・東京科学大学・早稲田大学・慶應義塾大学をはじめとする難関大の学生に多くご登録いただいています。学部・学年は問わず、在学中の方であればご登録いただけます。',
      },
      {
        q: '応募から採用までどれくらいかかりますか？',
        a: '企業や選考フローによって異なります。応募後は企業から登録メールアドレス宛に連絡が届き、書類選考・面接を経てインターン開始となります。',
      },
      {
        q: '複数の求人に応募できますか？',
  ...
  },
  {
    ...
    items: [
      {
        q: '料金体系を教えてください。',
        a: '初期費用と月額掲載料のシンプルな料金体系で、掲載件数・採用人数に関わらず定額でご利用いただけます。詳しくは「企業の方へ」ページをご覧ください。',
      },
      {
        q: '求人を掲載するまでどれくらいかかりますか？',
        a: 'お申し込み後、担当者のヒアリングと掲載審査を経て掲載開始となります。求人票の作成は担当者がサポートします。',
      },
      {
        q: 'どんな学生が登録していますか？',
        a: '東京大学・京都大学・一橋大学・東京科学大学・早稲田大学・慶應義塾大学をはじめとする難関大の学生が中心です。長期インターンで実務経験を積むことに意欲的な学生が集まっています。',
      },
      {
        q: '採用が決まった場合に追加費用はかかりますか？',
        a: '現行の掲載プランは月額定額制のため、採用人数にかかわらず追加費用はかかりません。将来、料金体系を変更する場合は、事前に個別にご案内します。',
      },
      {
        q: '応募者の管理はどこで行いますか？',
