      ...
      <div style={{ ...S.card, padding: isMobile ? '32px 24px' : '48px 44px' }}>
        ...
        {done ? (
          <div style={{ textAlign: 'center' }}>
            ...
            <button onClick={() => router.push('/auth/login')} style={{ background: '#F2620C', color: '#fff', border: 'none', borderRadius: 10, padding: '13px 32px', fontFamily: "var(--font-sans)", fontWeight: 700, fontSize: 14, cursor: 'pointer', marginTop: 16 }}>
              ログインする
            </button>
          </div>
        ) : (
          <>
            ...
            <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
              ...
              <button type="submit" disabled={loading} style={{ background: '#F2620C', color: '#fff', border: 'none', borderRadius: 10, padding: '15px', fontFamily: "var(--font-sans)", fontWeight: 700, fontSize: 15, cursor: 'pointer', opacity: loading ? 0.7 : 1, marginTop: 8 }}>
